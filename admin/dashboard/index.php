...
<?php $title = "Admin Dashboard"; $path = '../../'; require_once '../../app/head.php'; ?>
<body>
                        ...
                        <div class="card info-card sales-card">
                            <div class="card-body">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="ps-3">
                                        <h6><?=fetchCount('users', 'user_type', 'Student')?></h6>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card info-card revenue-card">
                            <div class="card-body">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="ps-3">
                                        <h6><?=fetchCount('users', 'user_type', 'Teacher')?></h6>
                                    </div>
                                </div>
                            </div>
                        </div>
